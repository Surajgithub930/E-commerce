...
export default function AddProduct() {
    ...
    // let { productBrand, productConfig, productType, productPrice, productRating } = data
    ...
    let [productConfig, setProductConfig] = useState('')
    ...
    async function handleSubmit(e) {
        ...
        data.append('productConfig', productConfig)
        data.append('image', image)

        await axios.post('http://localhost:3500/api/saveProduct', data, {
            headers: {
                        ...
                        <form action="#" method="POST" className="mt-8" onSubmit={handleSubmit}>
                            <div className="space-y-5">
                                ...
                                <div>
                                    ...
                                    >
                                        Save Product <ArrowRight className="ml-2" size={16} />
                                    </button>
                                </div>
                            </div>
                        </form>
